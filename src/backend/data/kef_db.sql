...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2025 lúc 08:05 AM
...
--
-- Cấu trúc bảng cho bảng `danhgiacauhoi`
--
...
--
-- Đang đổ dữ liệu cho bảng `danhgiacauhoi`
--
...
--
-- Cấu trúc bảng cho bảng `danhgiacautraloi`
--
...
--
-- Đang đổ dữ liệu cho bảng `danhgiacautraloi`
--
...
--
-- Cấu trúc bảng cho bảng `danhsachtag`
--
...
--
-- Đang đổ dữ liệu cho bảng `danhsachtag`
--
...
--
-- Đang đổ dữ liệu cho bảng `danhsachtailieu`
--
...
--
-- Cấu trúc bảng cho bảng `dinhdang`
--
...
--
-- Đang đổ dữ liệu cho bảng `dinhdang`
--
...
--
-- Cấu trúc bảng cho bảng `luutailieu`
--
...
--
-- Chỉ mục cho bảng `danhgiacauhoi`
--
...
--
-- Chỉ mục cho bảng `danhgiacautraloi`
--
...
--
-- AUTO_INCREMENT cho bảng `dinhdang`
--
ALTER TABLE `dinhdang`
...
--
-- Các ràng buộc cho bảng `baocaovipham`
--
ALTER TABLE `baocaovipham`
...
--
-- Các ràng buộc cho bảng `danhgiacauhoi`
--
ALTER TABLE `danhgiacauhoi`
...
--
-- Các ràng buộc cho bảng `danhgiacautraloi`
--
ALTER TABLE `danhgiacautraloi`
...
--
-- Các ràng buộc cho bảng `danhsachtag`
--
ALTER TABLE `danhsachtag`
...
--
-- Các ràng buộc cho bảng `luutailieu`
--
ALTER TABLE `luutailieu`
