...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2025 at 04:01 AM
...
INSERT INTO `cauhoi` (`maCauHoi`, `maSinhVien`, `maMon`, `tieuDeCH`, `noiDungCH`, `ngayDatCH`, `trangThaiCH`, `luotTraLoi`) VALUES
...
CREATE TABLE `cautraloi` (
  ...
  `trangThaiCTL` enum('pending','approved','rejected') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
(1, 1, 1, 'Bạn có thể khai báo biến bằng cú pháp: <kiểu dữ liệu> <tên biến>; Ví dụ: int a; float b; Việc khai báo nên thực hiện ở đầu hàm để tránh lỗi.', '2025-11-18 23:01:00', 'approved'),
(2, 2, 1, 'Trong C, biến phải khai báo trước khi sử dụng. Các kiểu phổ biến: int, float, double, char. Ví dụ: char c = \'\'A\'\';', '2025-11-18 23:02:00', 'approved'),
(3, 3, 1, 'Bạn xem lại phần khai báo biến trong giáo trình chương 2, trong đó có giải thích rõ về phạm vi biến và khai báo nhiều biến cùng lúc.', '2025-11-18 23:03:00', 'approved'),
(4, 1, 2, 'Thiết kế CSDL nên bắt đầu bằng xác định yêu cầu, sau đó vẽ mô hình thực thể – liên kết (ERD), rồi mới chuyển sang mô hình quan hệ.', '2025-11-18 23:04:00', 'approved'),
(5, 2, 2, 'Bạn nên chuẩn hóa dữ liệu đến 3NF để giảm dư thừa. Các bước: xác định khóa chính, loại bỏ phụ thuộc bắc cầu...', '2025-11-18 23:05:00', 'approved'),
(6, 3, 2, 'Dùng MySQL Workbench để mô hình hóa rất tiện. Bạn chỉ cần kéo thả để tạo bảng và quan hệ.', '2025-11-18 23:06:00', 'approved'),
(7, 1, 3, 'QuickSort chia mảng thành 2 phần dựa vào pivot, sau đó đệ quy sắp xếp từng phần. Đây là thuật toán rất hiệu quả.', '2025-11-18 23:07:00', 'approved'),
(8, 2, 3, 'Pivot nên chọn phần tử giữa mảng để hạn chế trường hợp xấu. Sau khi chia, chỉ cần tiếp tục đệ quy là xong.', '2025-11-18 23:08:00', 'approved'),
(9, 3, 3, 'QuickSort trung bình có độ phức tạp O(n log n), nhưng trường hợp xấu là O(n^2).', '2025-11-18 23:09:00', 'approved'),
(10, 1, 4, 'Nguyên lý kế toán cung cấp khái niệm tài sản, nguồn vốn, doanh thu, chi phí… Hiểu rõ các khái niệm là nền tảng để học sâu hơn.', '2025-11-18 23:10:00', 'approved'),
(11, 2, 4, 'Công thức kế toán cơ bản: Tài sản = Nợ phải trả + Vốn chủ sở hữu. Công thức này luôn đúng.', '2025-11-18 23:11:00', 'approved'),
(12, 3, 4, 'Bạn nên đọc giáo trình chương 1 và 2 để nắm rõ các nguyên tắc và chuẩn mực.', '2025-11-18 23:12:00', 'approved'),
(13, 1, 5, 'Thuế GTGT đầu ra = Giá tính thuế * thuế suất. Thuế đầu vào tính dựa trên hóa đơn mua vào hợp lệ.', '2025-11-18 23:13:00', 'approved'),
(14, 2, 5, 'Tùy loại hàng hóa mà thuế suất có thể 5% hoặc 10%. Cần xác định đúng để tránh sai sót.', '2025-11-18 23:14:00', 'approved'),
(15, 3, 5, 'Bạn nên xem bảng thuế GTGT do Bộ Tài chính ban hành để tính chính xác.', '2025-11-18 23:15:00', 'approved'),
(16, 1, 6, 'Âm hữu thanh khi phát âm sẽ rung dây thanh quản. Bạn có thể dùng tay đặt lên cổ để kiểm tra.', '2025-11-18 23:16:00', 'approved'),
(17, 2, 6, 'Ví dụ âm hữu thanh: /b/, /d/, /g/. Âm vô thanh: /p/, /t/, /k/.', '2025-11-18 23:17:00', 'approved'),
(18, 3, 6, 'Bạn xem video trên YouTube về “voiced vs voiceless sounds”, rất dễ hiểu.', '2025-11-18 23:18:00', 'approved'),
(19, 1, 7, 'Dịch câu phải xét ngữ cảnh, người nói, mục đích, thời điểm. Không nên dịch từng từ.', '2025-11-18 23:19:00', 'approved'),
(20, 2, 7, 'Bạn nên dùng từ điển Oxford hoặc Cambridge để tra collocation cho tự nhiên.', '2025-11-18 23:20:00', 'approved'),
(21, 3, 7, 'Hãy đọc nhiều câu mẫu để quen ngữ pháp và cách diễn đạt.', '2025-11-18 23:21:00', 'approved'),
(22, 1, 8, '4P gồm: Product (sản phẩm), Price (giá), Place (kênh phân phối).', '2025-11-18 23:22:00', 'approved'),
(23, 2, 8, 'Ngoài 3P trên, yếu tố cuối là Promotion (xúc tiến).', '2025-11-18 23:23:00', 'approved'),
(24, 3, 8, 'Bạn có thể tìm mô hình 4P trong bất kỳ giáo trình Marketing căn bản.', '2025-11-18 23:24:00', 'approved'),
(25, 1, 9, 'Quản trị là quá trình hoạch định, tổ chức, lãnh đạo và kiểm soát để đạt mục tiêu.', '2025-11-18 23:25:00', 'approved'),
(26, 2, 9, 'Nhà quản trị có vai trò điều hành nhân sự, đưa ra quyết định và giải quyết vấn đề.', '2025-11-18 23:26:00', 'approved'),
(27, 3, 9, 'Quản trị giúp sử dụng hiệu quả nguồn lực như con người, tài chính và thời gian.', '2025-11-18 23:27:00', 'approved'),
(28, 1, 10, 'Quy trình gồm: làm đất, gieo sạ hoặc cấy, chăm sóc, bón phân, phòng sâu bệnh, thu hoạch.', '2025-11-18 23:28:00', 'approved'),
(29, 2, 10, 'Giai đoạn chăm sóc cần theo dõi nước và dinh dưỡng điều hòa.', '2025-11-18 23:29:00', 'approved'),
(30, 3, 10, 'Thu hoạch khi lúa đạt độ chín vàng 85–90%.', '2025-11-18 23:30:00', 'approved');
...
CREATE TABLE `sinhvien` (
  ...
  `trangThaiTK` enum('not_banned','banned') NOT NULL
...
INSERT INTO `sinhvien` (`maSinhVien`, `maNganh`, `hoTenSV`, `emailSV`, `matKhauSV`, `ngayTao`, `truongHoc`, `avatarURL`, `trangThaiTK`) VALUES
(1, 1, 'Nguyễn Văn A', 'sva@gmail.com', '$2a$10$i2eieYsa8q3oQanl/IdKJOS99UlKgzIWrtLyEwPzh5TMxyLjANrjO', '2025-11-18 22:20:04', NULL, NULL, 'not_banned'),
(2, 2, 'Tran Thi B', 'svb@gmail.com', '$2a$10$x.Mu3TpgSQq4GSvHjIdO1eGmJFzdBGHTXzqaW2vQgklwbBtRA1D6O', '2025-11-18 22:21:45', NULL, NULL, 'not_banned'),
(3, 1, 'Le Van C', 'svc@gmail.com', '$2a$10$bLjmW7Pm/KwTmCH9LCWIBu1iKksKCh964kQfCv/CjWVI6KEssBM/6', '2025-11-18 22:22:13', NULL, NULL, 'not_banned'),
(4, 1, 'Hà Gia Lộc', 'hagialoc@gmail.com', '$2a$10$46SbHE19S13/0I.GJmUVIeETluzX5O9TmAh3iRPwcff0iaOfkVYfu', '2025-11-19 00:27:50', NULL, NULL, 'not_banned');
...
INSERT INTO `tailieu` (`maTaiLieu`, `maLoai`, `maDinhDang`, `maSinhVien`, `tieuDeTL`, `ngayChiaSe`, `trangThaiTL`, `URL`, `fileSizes`, `soLanLuu`, `luotTaiXuong`) VALUES
(1, 1, 1, 1, 'Giáo trình C căn bản', '2025-11-18 22:20:04', 'approved', 'tl1.pdf', 50000, 10, 5),
(2, 2, 3, 2, 'Slide CSDL chương 1', '2025-11-18 22:21:45', 'approved', 'tl2.pptx', 30000, 4, 3),
(3, 3, 1, 3, 'Đề thi lập trình C', '2025-11-18 22:22:13', 'pending', 'tl3.pdf', 20000, 2, 1),
(4, 4, 1, 1, 'Tài liệu thuật toán nâng cao', '2025-11-18 22:30:00', 'approved', 'tl4.pdf', 44000, 5, 2),
(5, 5, 2, 2, 'BTL cơ sở dữ liệu', '2025-11-18 22:40:00', 'approved', 'tl5.docx', 35000, 7, 4),
(6, 6, 1, 3, 'Bài báo về AI', '2025-11-18 22:50:00', 'approved', 'tl6.pdf', 60000, 8, 6),
(7, 7, 1, 1, 'Sổ tay sinh viên CNTT', '2025-11-18 23:00:00', 'approved', 'tl7.pdf', 25000, 3, 2),
(8, 1, 1, 2, 'Giáo trình kế toán', '2025-11-18 23:10:00', 'approved', 'tl8.pdf', 45000, 1, 1),
(9, 2, 4, 3, 'Slide Marketing', '2025-11-18 23:20:00', 'pending', 'tl9.ppt', 30000, 0, 0),
(10, 4, 1, 1, 'Tài liệu dịch thuật', '2025-11-18 23:30:00', 'approved', 'tl10.pdf', 38000, 9, 7);
